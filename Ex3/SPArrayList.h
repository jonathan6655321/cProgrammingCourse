...
#define FUNCTION_ERROR "Error: %s has failed"
/**
 * SPArrayList summary:
 *
...
/**
 * add element to the last location of the array.
 * if the array is full the array will be shifted (delete first elemnt).
 * @param src   - The source array list
 * @param elem  - The new element to be inserted
 * @return
 * SP_ARRAY_LIST_INVALID_ARGUMENT - if src == NULL
...
/**
 * Removes an element from a the last location of the array and returns it.
 * @param src   - The source array list
 * @param elem  - The new element to be inserted
 * @return
