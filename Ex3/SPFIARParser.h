...
/**
 * Parses a specified command string to SP_COMMAND.
 *
 * @return
 * A parsed SP_COMMAND that contains the command type, if the line is invalid then this field is
 *         set to INVALID_LINE.
 */
SP_COMMAND spPaserPraseCommand(char* str);

/**
 * Parses a specified integer between 1 to 7 string to int.
 *
 * @return
